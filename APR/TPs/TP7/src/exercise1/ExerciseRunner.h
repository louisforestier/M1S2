...
public:
    ExerciseRunner(PPMBitmap const*const input) :
        threads(32,32),
    ...
    {
        impl->run_blockEffect(dev_inputR, dev_outputR);
        impl->run_blockEffect(dev_inputG, dev_outputG);
        impl->run_blockEffect(dev_inputB, dev_outputB);
    }
