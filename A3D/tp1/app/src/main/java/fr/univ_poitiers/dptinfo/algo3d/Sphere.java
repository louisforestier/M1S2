...
// - modifier l'importeur d'obj pour ne construire les sommets qu'à la fin avec les coordonnées spatiales, les coordonnées de normales et les coordonnées de textures
