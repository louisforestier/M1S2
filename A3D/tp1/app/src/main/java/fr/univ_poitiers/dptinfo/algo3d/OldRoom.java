...
public class OldRoom {
    ...
    public OldRoom(float length, float width, float height, float[] ceilingColor, float[] floorColor, float[] wallColor){
        float x = width/2;
        float z = length/2;
        vertexpos = new float[]{
                -x, 0.F, -z,    // sommet 0
    ...
    public OldRoom(float length, float width, float height, float[] ceilingColor, float[] floorColor, float[] wallColor, float posx, float posz, float rotation) {
