...
public class Room extends GameObject {
    ...
    public Room(boolean[] doors, float length, float width, float height, float[] ceilingColor, float[] floorColor, float[] wallColor) {
        super();
        ...
        w2.getTransform().roty(270.f).posz(-width / 2);
        ...
        w4.getTransform().roty(90.f).posz(-width/2);
